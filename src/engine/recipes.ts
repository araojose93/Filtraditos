...
export function v60Facil(doseGrams: number): Recipe {
  ...
  return { id: "v60-facil", name: "V60 Fácil", ratio, steps, recommendedClickOffset: 0, targetTotalSeconds: 180 };
}
...
export function hoffmann(doseGrams: number): Recipe {
  ...
  return { id: "hoffmann", name: "Hoffmann", ratio, steps, recommendedClickOffset: 0, targetTotalSeconds: 210 };
}
...
export function tetsuKasuya46(doseGrams: number): Recipe {
  ...
  return { id: "tetsu-46", name: "Tetsu Kasuya 4:6", ratio, steps, recommendedClickOffset: 1, targetTotalSeconds: 210 };
}
